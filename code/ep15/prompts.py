...
from ep15.registry import build_available_skills_prompt
...
的细节、已经能从订单里查到的信息。不能记：身份证件号、银行卡号、健康状况这类敏感
信息——客人要求记也不记，礼貌说明一句即可。
笔记里已有的需求（比如无障碍、饮食禁忌），凡是跟这次问的事项有关，回答时要主动
照应，不要等客人再说一遍。
