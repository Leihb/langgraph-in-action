"""跑第 11 期：
    uv run python -m ep12.main wang t1 "订单 KL-901 想改期，但已经超过免费改期窗口了，我这边突然要住院"
    uv run python -m ep12.main --resume <user_id> <thread_id> approve
    uv run python -m ep12.main --history <thread_id>
    uv run python -m ep12.main --memory <user_id>
